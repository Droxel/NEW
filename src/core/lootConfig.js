...
export const LIFE_FRUIT_ITEM = { 
    ...
    icon: 'assets/chest/fruit of life.svg', 
    maxCount: 99,
    type: 'consumable', 
    value: 5 
};
export const TAMING_STAFF_ITEM = {
    ...
    icon: 'assets/chest/items/hand_staff.svg',
    maxCount: 1,
    type: 'pet_tool'
};
...
export const PET_BUBBLE_ITEM = {
    ...
    icon: 'assets/chest/items/bubble_pitomets.svg',
    maxCount: 1,
    type: 'pet_item'
};
...
// 1. СПИСКИ ПРЕДМЕТОВ
const RARE_LOOT = [
    { id: 'amulet_regeneration', name: 'Амулет регенерации', description: 'Восстанавливает здоровье', icon: 'assets/chest/items/Amulet of regeneration.svg' },
    { id: 'ring', name: 'Старое кольцо', description: 'Блестяшка', icon: 'assets/chest/items/ring.svg' },
    { id: 'mace', name: 'Булава', description: 'Тяжелый удар', icon: 'assets/chest/items/mace.svg', type: 'weapon', damage: 3 },
    { id: 'book', name: 'Книга Заклинаний', description: 'Магический урон', icon: 'assets/chest/items/book.svg', type: 'weapon', damage: 4 },
    { id: 'essence', name: 'Эссенция', description: 'Магия в чистом виде', icon: 'assets/chest/items/essence.svg', count: 2 } 
];

const COMMON_LOOT = [
    { id: 'potion_hp', name: 'Зелье Опыта', icon: 'assets/svg/xp.svg', weight: 40, maxCount: 3 },
    { id: 'crystal', name: 'Кристалл', icon: 'assets/png/crystal.png', weight: 60, maxCount: 12 },
    { id: 'threads', name: 'Нитки', icon: 'assets/chest/items/threads.svg', weight: 50, maxCount: 5 },
    { id: 'broken_sword', name: 'Сломанный меч', icon: 'assets/chest/items/broken sword.svg', weight: 30, maxCount: 1, type: 'weapon', damage: 2 },
    { id: 'stone', name: 'Камень', icon: 'assets/chest/items/stone.svg', weight: 70, maxCount: 15 },
    { id: 'poo', name: 'Кучка', icon: 'assets/chest/items/poo.svg', weight: 15, maxCount: 1 }
];
...
// Функция-помощник, чтобы не дублировать код
    ...
    if (type === "jungle") {
        ...
        addItemToSlot({ 
            id: 'hook', 
            name: 'Крюк-кошка', 
            icon: 'assets/chest/items/hook.svg',
            type: 'hook'
        });
    }
