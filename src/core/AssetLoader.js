...
dory: new Image(),
fugu_fish: new Image(),
fugu_fish2: new Image(),
miduza1: new Image(),
miduza2: new Image(),

// Ледяной босс (Ice Boss)
    ice_boss: new Image(),
    ice_boss2: new Image(),
    crystal_boss: new Image(),
    icicle: new Image(),
    ice_block: new Image(),
    protection_crystal: new Image(),

    deck: new Image(),
    cabin: new Image(),
    mast: new Image(),
    sideboard: new Image(),
    cursed_crystal: new Image(),

    // Кракен (Kraken)
    kraken_head: new Image(),
    tentacles1: new Image(),
    tentacles2: new Image(),
    tentacles3: new Image(),
    tentacles4: new Image(),
    tentacles5: new Image(),
    tentacles6: new Image(),
    tentacles7: new Image(),
    tentacles8: new Image(),
    tentacles9: new Image(),
    tentacles10: new Image(),
...
assets.bg_ocean.src = "../../assets/images/biomes/ocean.png";
// Сущности и UI
...
// Океан (world/ocean/)
assets.seaweed1.src = "../../assets/images/world/ocean/seaweed1.png";
assets.seaweed2.src = "../../assets/images/world/ocean/seaweed2.png";
assets.seaweed3.src = "../../assets/images/world/ocean/seaweed3.png";

assets.clownfish.src = "../../assets/images/entities/mobs/ocean/clownfish.png";
assets.dory.src = "../../assets/images/entities/mobs/ocean/dory_cabin.png";
assets.fugu_fish.src = "../../assets/images/entities/mobs/ocean/fugu_fish.png";
assets.fugu_fish2.src = "../../assets/images/entities/mobs/ocean/fugu_fish2.png";
assets.miduza1.src = "../../assets/images/entities/mobs/ocean/miduza1.png";
assets.miduza2.src = "../../assets/images/entities/mobs/ocean/miduza2.png";

const iceBossPath = "../../assets/images/entities/bosses/ice_boss/";
assets.ice_boss.src = iceBossPath + "Icy_boss.png";
assets.ice_boss2.src = iceBossPath + "Icy_boss2.png";
assets.crystal_boss.src = iceBossPath + "crystal_boss.png";
assets.icicle.src = iceBossPath + "icicle.png";
assets.ice_block.src = iceBossPath + "ice_block.png";
assets.protection_crystal.src = iceBossPath + "protection_crystal.png";

assets.deck.src = "../../assets/images/world/ship/deck.png";
assets.cabin.src = "../../assets/images/world/ship/cabin.png";
assets.mast.src = "../../assets/images/world/ship/mast.png";
assets.sideboard.src = "../../assets/images/world/ship/sideboard.png";
assets.cursed_crystal.src = "../../assets/images/world/ship/cursed_crystal.png";

// Кракен (entities/mobs/kraken/)
assets.kraken_head.src = "../../assets/images/entities/mobs/kraken/golova_krakin.png";
assets.tentacles1.src = "../../assets/images/entities/mobs/kraken/tentacles1.png";
assets.tentacles2.src = "../../assets/images/entities/mobs/kraken/tentacles2.png";
assets.tentacles3.src = "../../assets/images/entities/mobs/kraken/tentacles3.png";
assets.tentacles4.src = "../../assets/images/entities/mobs/kraken/tentacles4.png";
assets.tentacles5.src = "../../assets/images/entities/mobs/kraken/tentacles5.png";
assets.tentacles6.src = "../../assets/images/entities/mobs/kraken/tentacles6.png";
assets.tentacles7.src = "../../assets/images/entities/mobs/kraken/tentacles7.png";
assets.tentacles8.src = "../../assets/images/entities/mobs/kraken/tentacles8.png";
assets.tentacles9.src = "../../assets/images/entities/mobs/kraken/tentacles9.png";
